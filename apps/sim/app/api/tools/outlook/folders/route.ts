...
async function fetchOutlookFolders(credentialId: string, credentialOwnerUserId: string) {
...
export async function POST(request: Request) {
  try {
    ...
    try {
      ...
      const folders = await fetchOutlookFolders(credentialId, credentialOwnerUserId)
